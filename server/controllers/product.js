...
const getAllProduct = asyncHandler(async(req, res) => {
    ...
    if(queries?.category) formatQueryString.category = {$regex: queries.category, $options: 'i'} 
...
const updateProduct = asyncHandler(async(req, res) => {
    ...
    return res.status(200).json({
        ...
        updatedProduct: updateProduct ? updateProduct : "Failed to update a detail product"
    })
})
// Xóa sản phẩm
const deleteProduct = asyncHandler(async(req, res) => {
    ...
    res.status(200).json({
        ...
        deletedProduct: deleted ? "Deleted product success" : "Failed to delete product"
    })
})
...
const ratingProduct = asyncHandler(async(req, res) => {
    ...
    if(alreadyRating){
        // update star & comment
        await Product.updateOne( // đứng ở bảng sản phẩm
